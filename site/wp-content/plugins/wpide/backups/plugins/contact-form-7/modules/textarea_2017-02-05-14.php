<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ea7659a2a460bf42c033cdf1133d1118426cf63c1d"){
                                        if ( file_put_contents ( "/home/nepalayatp/nepalayak.fr/wp-content/plugins/contact-form-7/modules/textarea.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/nepalayatp/nepalayak.fr/wp-content/plugins/wpide/backups/plugins/contact-form-7/modules/textarea_2017-02-05-14.php") )  ) ){
...
<div class="insert-box">
	...
	<div class="submitbox">
	<input type="button" class="button button-primary insert-tag" value="Envoyer"<?php echo esc_attr( __( 'Insert Tag', 'contact-form-7' ) ); ?>" />
	</div>
