<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ea7659a2a460bf42c033cdf1133d11186a08f90e7e"){
                                        if ( file_put_contents ( "/home/nepalayatp/nepalayak.fr/wp-content/plugins/contact-form-7/modules/submit.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/nepalayatp/nepalayak.fr/wp-content/plugins/wpide/backups/plugins/contact-form-7/modules/submit_2017-02-20-13.php") )  ) ){
...
<div class="insert-box">
	...
	<div class="submitbox">
<input type="button" class="button button-primary insert-tag" value="<?php echo "Envoyer" /*esc_attr( __( 'Insert Tag', 'contact-form-7' ) )*/; ?>" />
</div>
</div>
<?php
}
