<?php /* start WPide restore code */
                                    if ($_POST["restorewpnonce"] === "ea7659a2a460bf42c033cdf1133d1118d7c7071445"){
                                        if ( file_put_contents ( "/home/nepalayatp/nepalayak.fr/wp-content/themes/Divi/includes/social_icons.php" ,  preg_replace("#<\?php /\* start WPide(.*)end WPide restore code \*/ \?>#s", "", file_get_contents("/home/nepalayatp/nepalayak.fr/wp-content/plugins/wpide/backups/themes/Divi/includes/social_icons_2016-10-28-02.php") )  ) ){
                                    ...
                                    die();
                            /* end WPide restore code */ ?><ul class="et-social-icons">
