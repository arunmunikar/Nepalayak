...
if ( ! empty( $_POST ) && check_admin_referer( 'phoen_woo_category_action', 'phoen_woo_category_action_field' ) ) {
	...
	if(sanitize_text_field( $_POST['cat_mode'] ) == 'Save'){
								
		$product_cat_btn	  = sanitize_text_field( $_POST['product_cat_btn'] ) ;
		 
		$product_cat_price    = sanitize_text_field( $_POST['product_cat_price'] ) ;
		
		$product_cat_rating   = sanitize_text_field( $_POST['product_cat_rating'] ) ;
		
		$product_cat_review   = sanitize_text_field( $_POST['product_cat_review'] ) ;
		
		$shop_cat_btn	  = sanitize_text_field( $_POST['shop_cat_btn'] ) ;
		 
		$shop_cat_price    = sanitize_text_field( $_POST['shop_cat_price'] ) ;
		
		$shop_cat_rating   = sanitize_text_field( $_POST['shop_cat_rating'] ) ;
